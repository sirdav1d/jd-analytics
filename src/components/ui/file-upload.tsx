...
export function GridPattern() {
	...
	const rows = 11;
	return (
		<div className='flex bg-secondary/80 shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105'>
					...
					return (
						<div
							...
							className={`w-10 h-10 flex shrink-0 rounded-[2px] ${
								index % 2 === 0
									? 'bg-background'
									: 'bg-secondary shadow-[0px_0px_1px_3px_rgba(150,150,150,.1)_inset] dark:shadow-[0px_0px_1px_2px_rgba(0,0,0,0.15)_inset]'
							}`}
						/>
					);
				}),
