	...
	try {
      ...
      `,
		...
		return NextResponse.json({
			...
			data: {
				current: {
					totalRevenue: totalReceitaAtual,
					averageTicket: ticketMedioAtual,
					totalSales: totalVendasAtual,
					newCustomers: novosClientesAtual,
					recurringCustomers: recorrentesAtual,
					revenuePerCustomer: revPorClienteAtual,
				},
				previous: {
					totalRevenue: totalReceitaAnt,
					averageTicket: ticketMedioAnt,
					totalSales: totalVendasAnt,
					newCustomers: novosClientesAnt,
					recurringCustomers: recorrentesAnt,
					revenuePerCustomer: revPorClienteAnt,
				},
				diff: {
					totalRevenue: faturamentoDiff.diff,
					totalRevenuePct: faturamentoDiff.pct,
					averageTicket: ticketMedioDiff.diff,
					averageTicketPct: ticketMedioDiff.pct,
					totalSales: vendasDiff.diff,
					totalSalesPct: vendasDiff.pct,
					newCustomers: novosClientesDiff.diff,
					newCustomersPct: novosClientesDiff.pct,
					recurringCustomers: recorrentesDiff.diff,
					recurringCustomersPct: recorrentesDiff.pct,
					revenuePerCustomer: revPorClienteDiff.diff,
					revenuePerCustomerPct: revPorClienteDiff.pct,
				},
			},
			error: null,
		});
