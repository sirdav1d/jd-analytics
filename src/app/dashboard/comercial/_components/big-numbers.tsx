					...
					<CardContent>
						<div className='text-2xl font-bold flex items-center gap-3 '>
							{allData.data.current.recurringCustomers
								? allData.data.current.recurringCustomers.toLocaleString(
										'pt-BR',
									)
								: 0}
							<Badge
						...
						<p className='text-xs text-muted-foreground mt-1'>
							...
							{allData.data.previous.recurringCustomers
								? allData.data.previous.recurringCustomers.toLocaleString(
										'pt-BR',
									)
								: 0}
						</p>
					...
					<CardContent>
						<div className='text-2xl font-bold flex items-center gap-3 '>
							{allData.data.current.revenuePerCustomer
								? allData.data.current.revenuePerCustomer.toLocaleString(
										'pt-BR',
									)
								: 0}
							<Badge
						...
						<p className='text-xs text-muted-foreground mt-1'>
							...
							{allData.data.previous.revenuePerCustomer
								? allData.data.previous.revenuePerCustomer.toLocaleString(
										'pt-BR',
									)
								: 0}
						</p>
